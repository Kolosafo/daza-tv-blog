...
const extraApiKey = "AIzaSyB1Dpyx3oKo1Vec4lxE_sJGsUiVFnf9qu4";
...
export const getYouTubeThumbnails = async () => {
  ...
  const url = `https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UCb4BvFRquPfEEmpwFYiMAog&key=${baseApiUrl}&maxResults=4`;
